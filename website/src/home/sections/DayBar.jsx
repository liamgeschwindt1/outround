                ...
                >
                  ...
                  <div
                    style={{
                      fontFamily: 'var(--font-mono)',
                      fontSize: 10,
                      color: 'rgba(242,107,69,0.45)',
                      marginTop: 6,
                    }}
                  >
                    per month &middot; {dispReps} rep{dispReps !== 1 ? 's' : ''} &middot; 3% close
                    rate
                  </div>
                </div>
              </motion.div>
